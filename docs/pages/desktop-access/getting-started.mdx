...
and written to the console. Teleport will not need this password, as it uses
x509 certificates for LDAP authentication.
...
Write-Host "Generated password for $SamAccountName: $Password"
Write_Host "Please note this for your records."
